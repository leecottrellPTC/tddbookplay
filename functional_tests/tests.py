...
class NewVisitorTest(LiveServerTestCase):#liveservertestcase clears the database for us
    def setUp(self):
    ...
    #book this is test_can_start_a_list_for_one_user(self)
    def test_createAndRetrieveListForOneUser(self):
